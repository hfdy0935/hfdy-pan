...
public class CaptchaUtil {
    ...
    private String randomStr(int n) {
        // 为了避免混淆用户视觉，去掉了0和O、1和L
        String str1 = "ABCDEFGHJKMNPQRSTUVWXYZabcdefghijkmnpqrstuvwxyz23456789";
        String str2 = "";
    ...
    private Font getFont(int size) {
        ...
        font[4] = new Font("Gill Sans Ultra Blod", Font.PLAIN, size);
